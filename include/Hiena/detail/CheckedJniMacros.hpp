...
#define HIENA_UNCHECKED_METHOD(RETTYPE, FUNCNAME, TYPES) \
    HIENA_UNCHECKED_METHOD_IMPL(RETTYPE, FUNCNAME, HIENA_PP_ZIP(TYPES,(,), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a)), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a))
...
#define HIENA_CHECKED_METHOD(RETTYPE, FUNCNAME, TYPES) \
    HIENA_CHECKED_METHOD_IMPL(RETTYPE, FUNCNAME, HIENA_PP_ZIP(TYPES,(,), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a)), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a))

#define HIENA_CHECKED_VARIADIC_VOID_METHOD(FUNC, TYPES) \
    HIENA_CHECKED_VARIADIC_VOID_METHOD_IMPL(FUNC, HIENA_PP_ZIP(TYPES,(,), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a)), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a))

#define HIENA_CHECKED_VARIADIC_METHOD(TYPE, FUNC, TYPES) \
    HIENA_CHECKED_VARIADIC_METHOD_IMPL(TYPE, FUNC, HIENA_PP_ZIP(TYPES,(,), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a)), HIENA_PP_NAMED_FUNC_ARGS(TYPES, a))
